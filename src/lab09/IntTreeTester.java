...
public class IntTreeTester {
	public static void main(String[] args){
		...
		if (!empty_tree.getLevel(1).equals(""))
			System.err.println("TEST FAILED: getLevel() with empty tree");
		...
		if (!tree4.getInorder().equals(" 4  2  0  1  0  3  0 "))
			System.err.println("TEST FAILED: makePerfect() with tree4");				
		
		tree6.makePerfect();
		if (!tree6.getInorder().equals(" 4  2  5  1  6  3  0 "))
			System.err.println("TEST FAILED: makePerfect() with tree6");						
		
		tree_ref1.makePerfect();
		if (!tree_ref1.getInorder().equals(" 1  5  0  3  4  2  6 "))
			System.err.println("TEST FAILED: makePerfect() with tree_ref1");						
